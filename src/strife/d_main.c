    ...
    do
    {
        do
        {
            ...
            I_Sleep(1);
                 ...
                 3); // haleyjd 08/23/2010: [STRIFE] Changed from == 0 to < 3

        // haleyjd 08/26/10: [STRIFE] Changed to use ColorXForm wipe.
        wipestart = nowtime;
        done = wipe_ScreenWipe(wipe_ColorXForm, 0, 0, SCREENWIDTH, SCREENHEIGHT,
                               tics);
        I_UpdateNoBlit();
...
void D_DoAdvanceDemo(void)
{
    ...
    switch (demosequence)
    {
        ...
        case 3:
            ...
            pagename =
                DEH_String("PANEL3"); // fanatics who heard the voice of a
            I_StartVoice(
                DEH_String("pro3")); // malignant God in their heads, and
        ...
        case 4:
            ...
            I_StartVoice(
                DEH_String("pro4")); // psychotics, who wield weapons more
        ...
        case 5:
            ...
            pagename =
                DEH_String("PANEL5"); // and live like animals in constant
        ...
        case 6:                        // But there are whispers of discontent.
            ...
            I_StartVoice(
                DEH_String("pro6")); // Movement is born! Born of lifelong
            break;                   // STRIFE!
