...
#else
// empty for undefined window position
...
#else
// use default switch handheld resolution
...
#else
// not needed on switch as we have a splash screen/screen is reserved for the game
